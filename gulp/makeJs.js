...
gulp.task("browserify", function() {
  return browserify({ entries: ["./src/browserify/entry.js"], standalone: "YASHEML", debug: true })
...
gulp.task("browserifyWithDeps", function() {
  var bundler = browserify({ entries: ["./src/browserify/entry.js"], standalone: "YASHEML", debug: true });
